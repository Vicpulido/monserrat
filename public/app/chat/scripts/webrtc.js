...
var details = {
    ...
    //path: (window.location.pathname.split('/').slice(0, -1).join('/') + '/socket.io')
    //path: (window.location.pathname.split('/').slice(0, -1).join('/') + '/dante/socket.io')
    //path: (address + '/dante/socket.io')
    path: ('/dante/socket.io')
};

//console.log('resource: ' + (window.location.pathname.split('/').slice(0, -1).join('/') + '/socket.io'));
...
// Get the roomId from the POST body if available
...
client.on('join', function (room) {
    ...
    console.log('This peer (you) is the initiator of room ' + room + '!');
    isChannelReady = true;
});
...
function gotStream(stream) {
    ...
    console.log('Sending message got user media.');
