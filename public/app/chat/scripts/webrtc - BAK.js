...
var configuration = {
    'iceServers': [
        ...
        //{ 'url': 'turn:numb.viagenie.ca', username: "vicpulido@hotmail.com", credential: "CompaneroJs1!" }
    ]
};
...
var socket = io.connect(window.location.protocol + '//' + window.location.hostname + ':8080',{ query: "ClientConnecting" });
...
socket.on('full', function(room) {
  ...
  alert('Room ' + room + ' is full, come back later!'); // We will create a new room for you.');
